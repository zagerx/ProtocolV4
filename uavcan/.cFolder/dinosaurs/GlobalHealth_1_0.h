...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/GlobalHealth.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.231986 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_GLOBAL_HEALTH_1_0_INCLUDED_
#define DINOSAURS_GLOBAL_HEALTH_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/GlobalHealth.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_GlobalHealth_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.GlobalHealth.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_GlobalHealth_1_0_FULL_NAME_             "dinosaurs.GlobalHealth"
#define dinosaurs_GlobalHealth_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.GlobalHealth.1.0"
...
#define dinosaurs_GlobalHealth_1_0_EXTENT_BYTES_                    1024UL
#define dinosaurs_GlobalHealth_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 552UL
static_assert(dinosaurs_GlobalHealth_1_0_EXTENT_BYTES_ >= dinosaurs_GlobalHealth_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// saturated uint16 ACCELEROMETER = 1
#define dinosaurs_GlobalHealth_1_0_ACCELEROMETER (1U)

/// saturated uint16 GYROSCOPE = 2
#define dinosaurs_GlobalHealth_1_0_GYROSCOPE (2U)

/// saturated uint16 IMU = 3
#define dinosaurs_GlobalHealth_1_0_IMU (3U)

/// saturated uint16 IR = 4
#define dinosaurs_GlobalHealth_1_0_IR (4U)

/// saturated uint16 LIDAR = 5
#define dinosaurs_GlobalHealth_1_0_LIDAR (5U)

/// saturated uint16 BAROMETER = 6
#define dinosaurs_GlobalHealth_1_0_BAROMETER (6U)

/// saturated uint16 SONAR = 7
#define dinosaurs_GlobalHealth_1_0_SONAR (7U)

/// saturated uint16 THERMOMETER = 8
#define dinosaurs_GlobalHealth_1_0_THERMOMETER (8U)

/// saturated uint16 ENCODER = 9
#define dinosaurs_GlobalHealth_1_0_ENCODER (9U)

/// saturated uint16 LINEAR_MOTOR = 21
#define dinosaurs_GlobalHealth_1_0_LINEAR_MOTOR (21U)

/// saturated uint16 ORDINARY_MOTOR = 22
#define dinosaurs_GlobalHealth_1_0_ORDINARY_MOTOR (22U)

/// saturated uint16 WHEELMOTOR = 23
#define dinosaurs_GlobalHealth_1_0_WHEELMOTOR (23U)

/// saturated uint16 BEEPER = 31
#define dinosaurs_GlobalHealth_1_0_BEEPER (31U)

/// saturated uint16 LIGHT = 32
#define dinosaurs_GlobalHealth_1_0_LIGHT (32U)

/// saturated uint16 BATTERY = 41
#define dinosaurs_GlobalHealth_1_0_BATTERY (41U)

/// saturated uint16 CHARGER = 42
#define dinosaurs_GlobalHealth_1_0_CHARGER (42U)

/// Array metadata for: saturated uint8[<=32] error_code
#define dinosaurs_GlobalHealth_1_0_error_code_ARRAY_CAPACITY_           32U
#define dinosaurs_GlobalHealth_1_0_error_code_ARRAY_IS_VARIABLE_LENGTH_ true
...
typedef struct
{
    ...
    {
        uint8_t elements[dinosaurs_GlobalHealth_1_0_error_code_ARRAY_CAPACITY_];
        size_t count;
    } error_code;

    /// uavcan.primitive.String.1.0 error_message
    uavcan_primitive_String_1_0 error_message;
} dinosaurs_GlobalHealth_1_0;
...
///                 @see dinosaurs_GlobalHealth_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_GlobalHealth_1_0_serialize_(
    const dinosaurs_GlobalHealth_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_GlobalHealth_1_0_deserialize_(
    dinosaurs_GlobalHealth_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void dinosaurs_GlobalHealth_1_0_initialize_(dinosaurs_GlobalHealth_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_GlobalHealth_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_GLOBAL_HEALTH_1_0_INCLUDED_
