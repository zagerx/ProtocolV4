...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/power/battery/Parameters.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.430472 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_POWER_BATTERY_PARAMETERS_1_0_INCLUDED_
#define DINOSAURS_POWER_BATTERY_PARAMETERS_1_0_INCLUDED_

#include <dinosaurs/power/battery/Technology_1_0.h>
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/power/battery/Parameters.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_power_battery_Parameters_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.power.battery.Parameters.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_power_battery_Parameters_1_0_FULL_NAME_             "dinosaurs.power.battery.Parameters"
#define dinosaurs_power_battery_Parameters_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.power.battery.Parameters.1.0"
...
#define dinosaurs_power_battery_Parameters_1_0_EXTENT_BYTES_                    303UL
#define dinosaurs_power_battery_Parameters_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 303UL
static_assert(dinosaurs_power_battery_Parameters_1_0_EXTENT_BYTES_ >= dinosaurs_power_battery_Parameters_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// Array metadata for: uavcan.si.unit.voltage.Scalar.1.0[2] design_cell_voltage_min_max
#define dinosaurs_power_battery_Parameters_1_0_design_cell_voltage_min_max_ARRAY_CAPACITY_           2U
#define dinosaurs_power_battery_Parameters_1_0_design_cell_voltage_min_max_ARRAY_IS_VARIABLE_LENGTH_ false

typedef struct
{
    /// uavcan.primitive.String.1.0 modelname
    uavcan_primitive_String_1_0 modelname;
...
///                 @see dinosaurs_power_battery_Parameters_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_power_battery_Parameters_1_0_serialize_(
    const dinosaurs_power_battery_Parameters_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    if ((8U * (size_t) capacity_bytes) < 2424UL)
    {
    ...
    {   // uavcan.primitive.String.1.0 modelname
        ...
        int8_t _err0_ = uavcan_primitive_String_1_0_serialize_(
            &obj->modelname, &buffer[offset_bits / 8U], &_size_bytes0_);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // uavcan.si.unit.electric_current.Scalar.1.0 discharge_current
        ...
        int8_t _err6_ = uavcan_si_unit_electric_current_Scalar_1_0_serialize_(
    ...
    {   // uavcan.si.unit.voltage.Scalar.1.0 charge_voltage
        ...
        int8_t _err16_ = uavcan_si_unit_voltage_Scalar_1_0_serialize_(
    ...
    {   // saturated uint32 cycle_count
        ...
        const int8_t _err17_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->cycle_count, 32U);
        if (_err17_ < 0)
        {
            return _err17_;
        }
    ...
    {   // dinosaurs.power.battery.Technology.1.0 technology
        ...
        int8_t _err19_ = dinosaurs_power_battery_Technology_1_0_serialize_(
    ...
    {   // uavcan.si.unit.voltage.Scalar.1.0 nominal_voltage
        ...
        int8_t _err21_ = uavcan_si_unit_voltage_Scalar_1_0_serialize_(
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_power_battery_Parameters_1_0_deserialize_(
    dinosaurs_power_battery_Parameters_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.primitive.String.1.0 modelname
    {
        ...
        const int8_t _err23_ = uavcan_primitive_String_1_0_deserialize_(
            &out_obj->modelname, &buffer[offset_bits / 8U], &_size_bytes11_);
        if (_err23_ < 0)
        {
            return _err23_;
        }
    ...
    // uavcan.si.unit.electric_current.Scalar.1.0 discharge_current
    {
        ...
        const int8_t _err26_ = uavcan_si_unit_electric_current_Scalar_1_0_deserialize_(
    ...
    // uavcan.si.unit.voltage.Scalar.1.0 charge_voltage
    {
        ...
        const int8_t _err31_ = uavcan_si_unit_voltage_Scalar_1_0_deserialize_(
    ...
    // saturated uint32 cycle_count
    out_obj->cycle_count = nunavutGetU32(&buffer[0], capacity_bytes, offset_bits, 32);
    offset_bits += 32U;
    offset_bits = (offset_bits + 7U) & ~(size_t) 7U;  // Align on 8 bits.
    // dinosaurs.power.battery.Technology.1.0 technology
    {
        size_t _size_bytes20_ = (size_t)(capacity_bytes - nunavutChooseMin((offset_bits / 8U), capacity_bytes));
        const int8_t _err32_ = dinosaurs_power_battery_Technology_1_0_deserialize_(
    ...
    // uavcan.si.unit.voltage.Scalar.1.0 nominal_voltage
    {
        ...
        const int8_t _err33_ = uavcan_si_unit_voltage_Scalar_1_0_deserialize_(
...
static inline void dinosaurs_power_battery_Parameters_1_0_initialize_(dinosaurs_power_battery_Parameters_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_power_battery_Parameters_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_POWER_BATTERY_PARAMETERS_1_0_INCLUDED_
