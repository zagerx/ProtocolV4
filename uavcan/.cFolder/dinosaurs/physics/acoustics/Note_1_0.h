...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/physics/acoustics/Note.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.608228 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_PHYSICS_ACOUSTICS_NOTE_1_0_INCLUDED_
#define DINOSAURS_PHYSICS_ACOUSTICS_NOTE_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/physics/acoustics/Note.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_physics_acoustics_Note_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.physics.acoustics.Note.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_physics_acoustics_Note_1_0_FULL_NAME_             "dinosaurs.physics.acoustics.Note"
#define dinosaurs_physics_acoustics_Note_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.physics.acoustics.Note.1.0"
...
#define dinosaurs_physics_acoustics_Note_1_0_EXTENT_BYTES_                    12UL
#define dinosaurs_physics_acoustics_Note_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 12UL
static_assert(dinosaurs_physics_acoustics_Note_1_0_EXTENT_BYTES_ >= dinosaurs_physics_acoustics_Note_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
...
} dinosaurs_physics_acoustics_Note_1_0;
...
///                 @see dinosaurs_physics_acoustics_Note_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_physics_acoustics_Note_1_0_serialize_(
    const dinosaurs_physics_acoustics_Note_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_physics_acoustics_Note_1_0_deserialize_(
    dinosaurs_physics_acoustics_Note_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void dinosaurs_physics_acoustics_Note_1_0_initialize_(dinosaurs_physics_acoustics_Note_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_physics_acoustics_Note_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_PHYSICS_ACOUSTICS_NOTE_1_0_INCLUDED_
