...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/SetProtectParameter.2.0.uavcan
// Generated at:  2025-06-26 11:12:32.318773 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_ACTUATOR_WHEEL_MOTOR_SET_PROTECT_PARAMETER_2_0_INCLUDED_
#define DINOSAURS_ACTUATOR_WHEEL_MOTOR_SET_PROTECT_PARAMETER_2_0_INCLUDED_

#include <dinosaurs/actuator/wheel_motor/ProtectParameter_2_0.h>
#include <nunavut/support/serialization.h>
#include <stdint.h>
#include <stdlib.h>

static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/SetProtectParameter.2.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_2_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.wheel_motor.SetProtectParameter.2.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_2_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.SetProtectParameter"
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_2_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.SetProtectParameter.2.0"

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.wheel_motor.SetProtectParameter.Request.2.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.SetProtectParameter.Request"
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.SetProtectParameter.Request.2.0"
...
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_EXTENT_BYTES_                    176UL
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 176UL
static_assert(dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_EXTENT_BYTES_ >= dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

typedef struct
{
    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overcurrent
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 overcurrent;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overvoltage
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 overvoltage;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 undervoltage
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 undervoltage;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 overtemperature;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 lowtemperature;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 overtemperature_wheels;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 lowtemperature_wheels;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 block_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 block_wheels;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_lose_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 phase_lose_wheels;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_overcurrent_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 phase_overcurrent_wheels;

    /// dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 encoder_err_wheels
    dinosaurs_actuator_wheel_motor_ProtectParameter_2_0 encoder_err_wheels;
} dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0;
...
///                 @see dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_serialize_(
    const dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overcurrent
        ...
        int8_t _err0_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overvoltage
        ...
        int8_t _err2_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 undervoltage
        ...
        int8_t _err4_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature
        ...
        int8_t _err6_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature
        ...
        int8_t _err8_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature_wheels
        ...
        int8_t _err10_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature_wheels
        ...
        int8_t _err12_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 block_wheels
        ...
        int8_t _err14_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_lose_wheels
        ...
        int8_t _err16_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_overcurrent_wheels
        ...
        int8_t _err18_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
    ...
    {   // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 encoder_err_wheels
        ...
        int8_t _err20_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_serialize_(
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_deserialize_(
    dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overcurrent
    {
        ...
        const int8_t _err22_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overvoltage
    {
        ...
        const int8_t _err23_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 undervoltage
    {
        ...
        const int8_t _err24_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature
    {
        ...
        const int8_t _err25_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature
    {
        ...
        const int8_t _err26_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 overtemperature_wheels
    {
        ...
        const int8_t _err27_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 lowtemperature_wheels
    {
        ...
        const int8_t _err28_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 block_wheels
    {
        ...
        const int8_t _err29_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_lose_wheels
    {
        ...
        const int8_t _err30_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 phase_overcurrent_wheels
    {
        ...
        const int8_t _err31_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
    ...
    // dinosaurs.actuator.wheel_motor.ProtectParameter.2.0 encoder_err_wheels
    {
        ...
        const int8_t _err32_ = dinosaurs_actuator_wheel_motor_ProtectParameter_2_0_deserialize_(
...
static inline void dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_initialize_(dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_wheel_motor_SetProtectParameter_Request_2_0_deserialize_(out_obj, &buf, &size_bytes);
...
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.SetProtectParameter.Response"
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.SetProtectParameter.Response.2.0"
...
/// instead of the extent because it provides a tighter bound of the object size; it is safe because the concrete type
/// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_EXTENT_BYTES_                    4UL
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 4UL
static_assert(dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_EXTENT_BYTES_ >= dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// saturated int32 SET_SUCCESS = 0
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_SET_SUCCESS (0L)

/// saturated int32 FAILED = 1
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_FAILED (1L)

/// saturated int32 PARAMETER_NOT_INIT = 2
#define dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_PARAMETER_NOT_INIT (2L)

typedef struct
{
    /// saturated int32 status
    int32_t status;
} dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0;
...
///
/// @param buffer   The destination buffer. There are no alignment requirements.
///                 @see dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
/// @param inout_buffer_size_bytes  When calling, this is a pointer to the size of the buffer in bytes.
///                                 Upon return this value will be updated with the size of the constructed serialized
///                                 representation (in bytes); this value is then to be passed over to the transport
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_serialize_(
    const dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    if ((obj == NULL) || (buffer == NULL) || (inout_buffer_size_bytes == NULL))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_deserialize_(
    dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    if ((out_obj == NULL) || (inout_buffer_size_bytes == NULL) || ((buffer == NULL) && (0 != *inout_buffer_size_bytes)))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
/// array beyond its length are left uninitialized; aliased union memory that is not used by the first union field
/// is left uninitialized, etc. If full zero-initialization is desired, just use memset(&obj, 0, sizeof(obj)).
static inline void dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_initialize_(dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_wheel_motor_SetProtectParameter_Response_2_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_ACTUATOR_WHEEL_MOTOR_SET_PROTECT_PARAMETER_2_0_INCLUDED_
