...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/Status.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.333666 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_ACTUATOR_WHEEL_MOTOR_STATUS_1_0_INCLUDED_
#define DINOSAURS_ACTUATOR_WHEEL_MOTOR_STATUS_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/Status.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_actuator_wheel_motor_Status_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.wheel_motor.Status.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_Status_1_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.Status"
#define dinosaurs_actuator_wheel_motor_Status_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.Status.1.0"
...
#define dinosaurs_actuator_wheel_motor_Status_1_0_EXTENT_BYTES_                    274UL
#define dinosaurs_actuator_wheel_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 274UL
static_assert(dinosaurs_actuator_wheel_motor_Status_1_0_EXTENT_BYTES_ >= dinosaurs_actuator_wheel_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// Array metadata for: uavcan.si.unit.electric_current.Scalar.1.0[<=16] motor_current
#define dinosaurs_actuator_wheel_motor_Status_1_0_motor_current_ARRAY_CAPACITY_           16U
#define dinosaurs_actuator_wheel_motor_Status_1_0_motor_current_ARRAY_IS_VARIABLE_LENGTH_ true

/// Array metadata for: uavcan.si.sample.temperature.Scalar.1.0[<=16] motor_temperature
#define dinosaurs_actuator_wheel_motor_Status_1_0_motor_temperature_ARRAY_CAPACITY_           16U
#define dinosaurs_actuator_wheel_motor_Status_1_0_motor_temperature_ARRAY_IS_VARIABLE_LENGTH_ true
...
typedef struct
{
    ...
    {
        uavcan_si_unit_electric_current_Scalar_1_0 elements[dinosaurs_actuator_wheel_motor_Status_1_0_motor_current_ARRAY_CAPACITY_];
        size_t count;
    } motor_current;
    ...
    {
        uavcan_si_sample_temperature_Scalar_1_0 elements[dinosaurs_actuator_wheel_motor_Status_1_0_motor_temperature_ARRAY_CAPACITY_];
        size_t count;
    } motor_temperature;
    ...
    uint8_t status;
} dinosaurs_actuator_wheel_motor_Status_1_0;
...
///                 @see dinosaurs_actuator_wheel_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_actuator_wheel_motor_Status_1_0_serialize_(
    const dinosaurs_actuator_wheel_motor_Status_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_Status_1_0_deserialize_(
    dinosaurs_actuator_wheel_motor_Status_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void dinosaurs_actuator_wheel_motor_Status_1_0_initialize_(dinosaurs_actuator_wheel_motor_Status_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_wheel_motor_Status_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_ACTUATOR_WHEEL_MOTOR_STATUS_1_0_INCLUDED_
