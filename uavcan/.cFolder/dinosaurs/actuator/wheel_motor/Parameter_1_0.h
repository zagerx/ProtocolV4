...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/Parameter.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.287485 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_ACTUATOR_WHEEL_MOTOR_PARAMETER_1_0_INCLUDED_
#define DINOSAURS_ACTUATOR_WHEEL_MOTOR_PARAMETER_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/wheel_motor/Parameter.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_actuator_wheel_motor_Parameter_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.wheel_motor.Parameter.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_Parameter_1_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.Parameter"
#define dinosaurs_actuator_wheel_motor_Parameter_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.Parameter.1.0"

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.wheel_motor.Parameter.Request.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.Parameter.Request"
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.Parameter.Request.1.0"
...
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_EXTENT_BYTES_                    256UL
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 152UL
static_assert(dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_EXTENT_BYTES_ >= dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// Array metadata for: saturated bool[<=16] odometry_polarity
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_odometry_polarity_ARRAY_CAPACITY_           16U
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_odometry_polarity_ARRAY_IS_VARIABLE_LENGTH_ true

/// Array metadata for: saturated bool[<=16] motor_polarity
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_motor_polarity_ARRAY_CAPACITY_           16U
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_motor_polarity_ARRAY_IS_VARIABLE_LENGTH_ true

/// Array metadata for: uavcan.si.unit.length.Scalar.1.0[<=16] radius
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_radius_ARRAY_CAPACITY_           16U
#define dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_radius_ARRAY_IS_VARIABLE_LENGTH_ true
...
typedef struct
{
    ...
    {
        uavcan_si_unit_length_Scalar_1_0 elements[dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_radius_ARRAY_CAPACITY_];
        size_t count;
    } radius;
} dinosaurs_actuator_wheel_motor_Parameter_Request_1_0;
...
///                 @see dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_serialize_(
    const dinosaurs_actuator_wheel_motor_Parameter_Request_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_deserialize_(
    dinosaurs_actuator_wheel_motor_Parameter_Request_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_initialize_(dinosaurs_actuator_wheel_motor_Parameter_Request_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_wheel_motor_Parameter_Request_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_FULL_NAME_             "dinosaurs.actuator.wheel_motor.Parameter.Response"
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.wheel_motor.Parameter.Response.1.0"
...
/// instead of the extent because it provides a tighter bound of the object size; it is safe because the concrete type
/// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_EXTENT_BYTES_                    4UL
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 4UL
static_assert(dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_EXTENT_BYTES_ >= dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// saturated int32 SET_SUCCESS = 0
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_SET_SUCCESS (0L)

/// saturated int32 PARAMETERS_EXCEPTION = 1
#define dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_PARAMETERS_EXCEPTION (1L)

typedef struct
{
    /// saturated int32 status
    int32_t status;
} dinosaurs_actuator_wheel_motor_Parameter_Response_1_0;
...
///
/// @param buffer   The destination buffer. There are no alignment requirements.
///                 @see dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
/// @param inout_buffer_size_bytes  When calling, this is a pointer to the size of the buffer in bytes.
///                                 Upon return this value will be updated with the size of the constructed serialized
///                                 representation (in bytes); this value is then to be passed over to the transport
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_serialize_(
    const dinosaurs_actuator_wheel_motor_Parameter_Response_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    if ((obj == NULL) || (buffer == NULL) || (inout_buffer_size_bytes == NULL))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_deserialize_(
    dinosaurs_actuator_wheel_motor_Parameter_Response_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    if ((out_obj == NULL) || (inout_buffer_size_bytes == NULL) || ((buffer == NULL) && (0 != *inout_buffer_size_bytes)))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
/// array beyond its length are left uninitialized; aliased union memory that is not used by the first union field
/// is left uninitialized, etc. If full zero-initialization is desired, just use memset(&obj, 0, sizeof(obj)).
static inline void dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_initialize_(dinosaurs_actuator_wheel_motor_Parameter_Response_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_wheel_motor_Parameter_Response_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_ACTUATOR_WHEEL_MOTOR_PARAMETER_1_0_INCLUDED_
