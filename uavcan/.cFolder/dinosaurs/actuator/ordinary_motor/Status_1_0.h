...
// Source file:   /home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/ordinary_motor/Status.1.0.uavcan
// Generated at:  2025-06-26 11:12:32.273773 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef DINOSAURS_ACTUATOR_ORDINARY_MOTOR_STATUS_1_0_INCLUDED_
#define DINOSAURS_ACTUATOR_ORDINARY_MOTOR_STATUS_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/zhangge/worknote/ProtocolV4/uavcan/custom_data_types/dinosaurs/actuator/ordinary_motor/Status.1.0.uavcan is trying to use a serialization library that was compiled with "
...
#define dinosaurs_actuator_ordinary_motor_Status_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | dinosaurs.actuator.ordinary_motor.Status.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define dinosaurs_actuator_ordinary_motor_Status_1_0_FULL_NAME_             "dinosaurs.actuator.ordinary_motor.Status"
#define dinosaurs_actuator_ordinary_motor_Status_1_0_FULL_NAME_AND_VERSION_ "dinosaurs.actuator.ordinary_motor.Status.1.0"
...
#define dinosaurs_actuator_ordinary_motor_Status_1_0_EXTENT_BYTES_                    49UL
#define dinosaurs_actuator_ordinary_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 49UL
static_assert(dinosaurs_actuator_ordinary_motor_Status_1_0_EXTENT_BYTES_ >= dinosaurs_actuator_ordinary_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
...
typedef struct
{
    ...
    uavcan_si_unit_electric_current_Scalar_1_0 motor_current;
    ...
    uavcan_si_sample_temperature_Scalar_1_0 driver_temperature;

    /// uavcan.si.sample.temperature.Scalar.1.0 motor_temperature
    uavcan_si_sample_temperature_Scalar_1_0 motor_temperature;
...
} dinosaurs_actuator_ordinary_motor_Status_1_0;
...
///                 @see dinosaurs_actuator_ordinary_motor_Status_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t dinosaurs_actuator_ordinary_motor_Status_1_0_serialize_(
    const dinosaurs_actuator_ordinary_motor_Status_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 motor_id
        ...
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->motor_id, 32U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
    ...
    {   // uavcan.si.unit.electric_current.Scalar.1.0 motor_current
        ...
        int8_t _err3_ = uavcan_si_unit_electric_current_Scalar_1_0_serialize_(
            &obj->motor_current, &buffer[offset_bits / 8U], &_size_bytes1_);
        if (_err3_ < 0)
        {
            return _err3_;
        }
    ...
    {   // uavcan.si.unit.voltage.Scalar.1.0 voltage
        ...
        int8_t _err5_ = uavcan_si_unit_voltage_Scalar_1_0_serialize_(
            &obj->voltage, &buffer[offset_bits / 8U], &_size_bytes2_);
        if (_err5_ < 0)
        {
            return _err5_;
        }
    ...
    {   // uavcan.si.sample.temperature.Scalar.1.0 driver_temperature
        size_t _size_bytes3_ = 11UL;  // Nested object (max) size, in bytes.
        int8_t _err7_ = uavcan_si_sample_temperature_Scalar_1_0_serialize_(
            &obj->driver_temperature, &buffer[offset_bits / 8U], &_size_bytes3_);
        if (_err7_ < 0)
        {
            return _err7_;
        }
    ...
    {   // uavcan.si.sample.temperature.Scalar.1.0 motor_temperature
        ...
        int8_t _err9_ = uavcan_si_sample_temperature_Scalar_1_0_serialize_(
            &obj->motor_temperature, &buffer[offset_bits / 8U], &_size_bytes4_);
        if (_err9_ < 0)
        {
            return _err9_;
        }
    ...
    {   // uavcan.si.unit.duration.Scalar.1.0 data_update_duration
        ...
        int8_t _err11_ = uavcan_si_unit_duration_Scalar_1_0_serialize_(
            &obj->data_update_duration, &buffer[offset_bits / 8U], &_size_bytes5_);
        if (_err11_ < 0)
        {
            return _err11_;
        }
    ...
    {   // uavcan.si.unit.angular_velocity.Scalar.1.0 angular_velocity
        ...
        int8_t _err13_ = uavcan_si_unit_angular_velocity_Scalar_1_0_serialize_(
            &obj->angular_velocity, &buffer[offset_bits / 8U], &_size_bytes6_);
        if (_err13_ < 0)
        {
            return _err13_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t dinosaurs_actuator_ordinary_motor_Status_1_0_deserialize_(
    dinosaurs_actuator_ordinary_motor_Status_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.si.unit.electric_current.Scalar.1.0 motor_current
    {
        ...
        const int8_t _err16_ = uavcan_si_unit_electric_current_Scalar_1_0_deserialize_(
            &out_obj->motor_current, &buffer[offset_bits / 8U], &_size_bytes8_);
        if (_err16_ < 0)
        {
            return _err16_;
        }
    ...
    // uavcan.si.unit.voltage.Scalar.1.0 voltage
    {
        ...
        const int8_t _err17_ = uavcan_si_unit_voltage_Scalar_1_0_deserialize_(
            &out_obj->voltage, &buffer[offset_bits / 8U], &_size_bytes9_);
        if (_err17_ < 0)
        {
            return _err17_;
        }
    ...
    // uavcan.si.sample.temperature.Scalar.1.0 driver_temperature
    {
        ...
        const int8_t _err18_ = uavcan_si_sample_temperature_Scalar_1_0_deserialize_(
            &out_obj->driver_temperature, &buffer[offset_bits / 8U], &_size_bytes10_);
        if (_err18_ < 0)
        {
            return _err18_;
        }
    ...
    // uavcan.si.sample.temperature.Scalar.1.0 motor_temperature
    {
        ...
        const int8_t _err19_ = uavcan_si_sample_temperature_Scalar_1_0_deserialize_(
            &out_obj->motor_temperature, &buffer[offset_bits / 8U], &_size_bytes11_);
        if (_err19_ < 0)
        {
            return _err19_;
        }
    ...
    // uavcan.si.unit.duration.Scalar.1.0 data_update_duration
    {
        ...
        const int8_t _err20_ = uavcan_si_unit_duration_Scalar_1_0_deserialize_(
            &out_obj->data_update_duration, &buffer[offset_bits / 8U], &_size_bytes12_);
        if (_err20_ < 0)
        {
            return _err20_;
        }
    ...
    // uavcan.si.unit.angular_velocity.Scalar.1.0 angular_velocity
    {
        ...
        const int8_t _err21_ = uavcan_si_unit_angular_velocity_Scalar_1_0_deserialize_(
            &out_obj->angular_velocity, &buffer[offset_bits / 8U], &_size_bytes13_);
        if (_err21_ < 0)
        {
            return _err21_;
        }
...
static inline void dinosaurs_actuator_ordinary_motor_Status_1_0_initialize_(dinosaurs_actuator_ordinary_motor_Status_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = dinosaurs_actuator_ordinary_motor_Status_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // DINOSAURS_ACTUATOR_ORDINARY_MOTOR_STATUS_1_0_INCLUDED_
